...
export default function DetailBanner({ token }) {
  ...
  const propertiesTable = [
    ...
    {
      title: "Price",
      value: token.token_price,
    },
    {
      title: "Max Amount",
      value: token.token_max_amount,
    },
    {
      title: "Address",
    ...
    {
      title: "Status",
      value: token.token_status,
    },
    {
      title: "Twitter",

      value: token.token_twitter || "-",
    },
    {
      title: "Telegram",
      value: token.token_telegram || "-",
    },
    {
      title: "Website",
      website: token.token_website || "-",
    },
  ];

  return (
      <Container>
        <div className={styles.containerCard + " pt-3"}>
